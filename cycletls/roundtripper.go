...
func (rt *roundTripper) getTransport(req *http.Request, addr string) error {
	...
	case "http":
		rt.cachedTransports[addr] = &http.Transport{DialContext: rt.dialer.DialContext, DisableKeepAlives: false}
		return nil
	case "https":
	default:
...
func (rt *roundTripper) dialTLS(ctx context.Context, network, addr string) (net.Conn, error) {
	...
	default:
		...
		rt.cachedTransports[addr] = &http.Transport{DialTLSContext: rt.dialTLS, DisableKeepAlives: false}
	}
